                            ...
                            @foreach ($set->galleryItems()->get() as $key => $item)
                                @if ($item->type == 'video')
                                    <div class="video-wrapp-full wrapp-full">
                                        ...
                                        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/{{getYouTubeId($item->src)}}" frameborder="0" allow="accelerometer; autoplay="1"; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                @endif
                            @endforeach
                        @endif
