...
<div class="title-block">
    <h3 class="title">Seturi <small>din colectia "{{ $collection->translationByLanguage()->first()->name }}"</small> </h3>
            ...
            <table class="table table-hover table-striped" id="tablelistsorter">
                ...
                <tbody>
                    ...
                    <tr id="{{ $set->id }}">
                        ...
                        <td>
                            {{ $set->translationByLanguage()->first()->name ?? trans('variables.another_name') }}
                        </td>
                        <td>
                            @if ($set->price)
                                {{ $set->price }} lei
