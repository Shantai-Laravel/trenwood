...
return [
    ...
    */
    ...
    'register' => [
      ...
      'subject' => "Регистрация",
      'message' => "Здравствуйте, перейдите по ссылке для завершения регистрации - http://dmm.admin.likemedia.top",
      "email" => "Ваш email - ",
      "password" => "Ваш пароль - ",
      "changePass" => "Здравствуйте, перейдите по ссылке для завершения регистрации, а также для смены пароля по желанию - http://dmm.admin.likemedia.top"
    ]
