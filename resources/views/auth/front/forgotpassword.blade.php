       ...
       <div class="col-auto">
          <div class="crumbs">
             <ul>
                ...
                <li><a href="{{url($lang->lang.'/password/email')}}">{{trans('front.forgotPass.forgot')}}</a></li>
             </ul>
          </div>
       </div>
    </div>
                 ...
                 <form action="{{ url()->current() }}" method="post">
                   ...
                   <div class="row justify-content-center align-items-center">
                     <div class="col-md-7">
                       ...
                       @endif
                       <input type="email" class="{{$errors->has('email') ? 'validationError' : ''}}" placeholder="{{trans('front.fields.email')}}*" name="email" style="padding: 5px;">
                     </div>
