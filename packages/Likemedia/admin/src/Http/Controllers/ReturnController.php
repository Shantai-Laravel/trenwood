   ...
   */
    ...
    public function create() {
        ...
        if(count($users) > 0) {
            ...
            return view('admin::admin.returns.create', compact('users', 'frontuser', 'return', 'orders', 'orderProducts_id', 'orderSets_id', 'address', 'userfields', 'countries', 'regions', 'cities'));
     ...
     *  method where returns are created, but they are not active, it makes active when click save button
     *  if page is create return it creates returns, else updates
     */
    ...
    /**
     *  post action
     *  Method which validate all required fields and if is valid call private method,
     *  which make return active and all other fields are filled
     */
    ...
    public function edit($id)
    {
        ...
        return view('admin::admin.returns.edit', compact('users', 'frontuser', 'return', 'orders', 'orderProducts_id', 'orderSets_id', 'address', 'userfields', 'countries', 'regions', 'cities'));
    }
    /**
     *  post action
     *  Delete return
     ...
     */
     ...
     /**
      *  post action
      *  Method which makes return active and fill return fields
      */
