...
<div class="title-block">
    <h3 class="title"> {{trans('front.admin.createReturn')}} </h3>
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4">
        ...
        <select class="form-control" name="status_return">
            <option value="new">{{trans('front.cabinet.status.new')}}</option>
            <option value="processing">{{trans('front.cabinet.status.processing')}}</option>
            <option value="cancelled">{{trans('front.cabinet.status.cancelled')}}</option>
            <option value="completed">{{trans('front.cabinet.status.completed')}}</option>
        </select>
      </div>
    </div>
