            ...
            <tbody>
                ...
                <tr id="{{ $product->id }}">
                    ...
                    <td class="text-center">
                        @if (!is_null($product->set()->first()))
                            <a href="{{ url('back/sets/collection/'.$product->set()->first()->collection_id) }}">{{ $product->set()->first()->translationByLanguage($lang->id)->first()->name }}</a>
                        @else
                            ---
                        @endif
                    </td>
